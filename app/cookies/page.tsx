...
export default function CookiesPolicy() {
  return (
    <>
      <Head>
        <title>Cookies Policy - stridekicks</title>
        <meta
          name="description"
          content="Learn how stridekicks uses cookies to enhance your browsing experience."
        />
      </Head>
      <div className="container mx-auto p-6">
        ...
        <p>
          The words with capitalized initials have meanings as defined below,
          regardless of singular or plural usage.
        </p>
        <h3 className="text-xl font-semibold mt-4">Definitions</h3>
        <ul className="list-disc ml-6">
          <li>
            <strong>Company:</strong> Refers to stridekicks ("the Company",
            "We", "Us", or "Our").
          </li>
          <li>
            <strong>Cookies:</strong> Small files placed on Your device,
            containing browsing history details among other uses.
          </li>
          <li>
        ...
        <ul className="list-disc ml-6">
          <li>
            ...
            <p>
              Purpose: These are required for essential website functionality
          ...
          <li>
            ...
            <p>
              Purpose: Used to remember your preferences and settings, providing
        ...
        <p>
          ...
          browser settings and delete stored Cookies. If You decline Cookies,
